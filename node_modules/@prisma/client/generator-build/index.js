...
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.17.0-31.393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/@prisma/engines-version/package.json"(exports2, module2) {
    module2.exports = {
...
// ../../node_modules/.pnpm/@prisma+engines-version@5.17.0-31.393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.17.0-31.393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/@prisma/engines-version/index.js"(exports2) {
    "use strict";
...
function buildFluentWrapperDefinition(modelName, outputType, context) {
  ...
  definition.add(property("[Symbol.toStringTag]", stringLiteral("PrismaPromise")).readonly());
...
var PrismaClientClass = class {
  constructor(context, internalDatasources, outputDir, runtimeNameTs, browser, cwd2) {
    this.context = context;
    this.internalDatasources = internalDatasources;
...
var TSClient = class {
  ...
  toJS() {
    ...
    const config = {
      generator,
      relativeEnvPaths,
      relativePath: pathToPosix(import_path4.default.relative(outputDir, import_path4.default.dirname(schemaPath))),
...
`;
  ...
  toTS() {
    ...
    const prismaClientClass = new PrismaClientClass(
      ...
      import_path4.default.dirname(this.options.schemaPath)
    );
...
To learn more about how to rename models, check out https://pris.ly/d/naming-models`;
  ...
  await Promise.all(
    Object.entries(fileMap).map(async ([fileName, file]) => {
      const filePath = import_path5.default.join(outputDir, fileName);
...
async function copyRuntimeFiles({ from, to, runtimeName, sourceMaps }) {
  ...
  await Promise.all(files.map((file) => import_promises.default.copyFile(import_path5.default.join(from, file), import_path5.default.join(to, file))));
}
