...
-- Bin type constraint
ALTER TABLE warehouse_bins DROP CONSTRAINT IF EXISTS chk_bin_type;
ALTER TABLE warehouse_bins ADD CONSTRAINT chk_bin_type CHECK (bin_type IN ('storage', 'receiving', 'shipping', 'returns', 'quarantine', 'picking'));
