...
DO $$
BEGIN
    -- Stock recalculation skipped on fresh install (no transaksi_harian data)
    RAISE NOTICE 'V008: persediaan stock recalculation skipped (fresh install)';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'V008: error ignored: %', SQLERRM;
END $$;
