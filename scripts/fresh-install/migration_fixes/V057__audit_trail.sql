...
-- Add missing columns to existing stub
ALTER TABLE audit_logs ADD COLUMN IF NOT EXISTS event_time TIMESTAMPTZ DEFAULT NOW();
...
ALTER TABLE audit_logs ADD COLUMN IF NOT EXISTS entity_type_v57 TEXT; -- already has entity_type
