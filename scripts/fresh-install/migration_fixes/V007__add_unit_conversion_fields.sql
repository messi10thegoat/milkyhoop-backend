...
DO $$ 
BEGIN
    -- Backfill of units_per_wholesale skipped on fresh install
    -- (no transaksi_harian data exists)
    RAISE NOTICE 'V007: unit_conversion backfill skipped (fresh install)';
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'V007: unit_conversion backfill error ignored: %', SQLERRM;
END $$;
