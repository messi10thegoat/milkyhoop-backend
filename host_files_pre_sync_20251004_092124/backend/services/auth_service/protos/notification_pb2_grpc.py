...
from protos.notification import notification_pb2 as notification_dot_notification__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in notification/notification_pb2_grpc.py depends on'
