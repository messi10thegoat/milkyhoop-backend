...
from app import api_gateway_python_prisma_pb2_grpc as pb_grpc
from app import api_gateway_python_prisma_pb2 as pb
...
class ApiGatewayPythonPrismaServicer(pb_grpc.ApiGatewayPythonPrismaServicer):
    async def DoSomething(self, request, context):
        ...
        return pb.ApiGatewayPythonPrismaResponse(
            status="ok",
...
async def serve() -> None:
    ...
    server = aio.server()
    pb_grpc.add_ApiGatewayPythonPrismaServicer_to_server(ApiGatewayPythonPrismaServicer(), server)
