...
onboarding_content = """📘 MilkyBot Onboarding Knowledge Base
...
async def main():
    tenant_id = "milkybot_onboarding"  # Dedicated tenant for MilkyBot knowledge
    ...
    async with grpc.aio.insecure_channel("localhost:5001") as crud_channel:
        ...
        print(f"✅ MilkyBot Knowledge injected: ID = {doc_id}")
    ...
    async with grpc.aio.insecure_channel("ragindex_service:5006") as index_channel:
        ...
        print("✅ MilkyBot Knowledge terindex ke FAISS")
