...
SCHEMA_PATH = Path('/root/milkyhoop-dev/backend/services/intent_parser/libs/milkyhoop_prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/root/milkyhoop-dev/backend/services/intent_parser/libs/milkyhoop_prisma/schema.prisma',
        }
