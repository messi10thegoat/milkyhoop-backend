...
from app import payment_service_pb2_grpc as pb_grpc
from app import payment_service_pb2 as pb
...
class Payment_serviceServicer(pb_grpc.Payment_serviceServicer):
    async def DoSomething(self, request, context):
        ...
        return pb.Payment_serviceResponse(
            status="ok",
...
async def serve() -> None:
    ...
    server = aio.server()
    pb_grpc.add_Payment_serviceServicer_to_server(Payment_serviceServicer(), server)
