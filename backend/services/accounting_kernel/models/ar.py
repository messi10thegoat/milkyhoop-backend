...
class AccountReceivable:
    """Accounts Receivable entity (subledger)"""
    id: UUID
    tenant_id: str
    customer_id: UUID
    ...
    payments: List["ARPaymentApplication"] = field(default_factory=list)
...
@dataclass
class CreateARRequest:
    """Request for creating AR"""
    tenant_id: str
    customer_id: UUID
    customer_name: Optional[str] = None
    source_type: SourceType = SourceType.INVOICE
...
@dataclass
class ApplyARPaymentRequest:
    """Request for applying payment to AR"""
    tenant_id: str
    ar_id: UUID
    payment_id: UUID
    payment_date: date
