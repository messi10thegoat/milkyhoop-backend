...
class Cust_contextServicer(pb_grpc.Cust_contextServicer):
    async def DoSomething(self, request, context):
        ...
        return pb.Cust_contextResponse(
            status="ok",
...
async def serve() -> None:
    ...
    server = aio.server()
    pb_grpc.add_Cust_contextServicer_to_server(Cust_contextServicer(), server)
