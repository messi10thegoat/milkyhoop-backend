...
-- Order
ALTER TABLE "Order" ALTER COLUMN total_price TYPE numeric(18,2) USING total_price::numeric(18,2);

-- UserFinance
ALTER TABLE "UserFinance" ALTER COLUMN balance TYPE numeric(18,2) USING balance::numeric(18,2);
...
ALTER TABLE bank_matching_history ALTER COLUMN bank_amount TYPE numeric(18,2) USING bank_amount::numeric(18,2);
...
ALTER TABLE bills ALTER COLUMN base_currency_total TYPE numeric(18,2) USING base_currency_total::numeric(18,2);
...
ALTER TABLE bills ALTER COLUMN exchange_rate TYPE numeric(18,6) USING exchange_rate::numeric(18,6);
...
ALTER TABLE credit_notes ALTER COLUMN base_currency_total TYPE numeric(18,2) USING base_currency_total::numeric(18,2);
ALTER TABLE credit_notes ALTER COLUMN discount_amount TYPE numeric(18,2) USING discount_amount::numeric(18,2);
ALTER TABLE credit_notes ALTER COLUMN exchange_rate TYPE numeric(18,6) USING exchange_rate::numeric(18,6);
...
ALTER TABLE credit_notes ALTER COLUMN total_cogs TYPE numeric(18,2) USING total_cogs::numeric(18,2);
...
ALTER TABLE customers ALTER COLUMN total_nilai TYPE numeric(18,2) USING total_nilai::numeric(18,2);

-- expense_claim_lines
ALTER TABLE expense_claim_lines ALTER COLUMN amount TYPE numeric(18,2) USING amount::numeric(18,2);

-- expense_claims
ALTER TABLE expense_claims ALTER COLUMN total_amount TYPE numeric(18,2) USING total_amount::numeric(18,2);

-- expense_items
ALTER TABLE expense_items ALTER COLUMN amount TYPE numeric(18,2) USING amount::numeric(18,2);

-- expense_policies
ALTER TABLE expense_policies ALTER COLUMN max_claim_amount TYPE numeric(18,2) USING max_claim_amount::numeric(18,2);
...
-- forex_gain_loss
ALTER TABLE forex_gain_loss ALTER COLUMN gain_loss_amount TYPE numeric(18,2) USING gain_loss_amount::numeric(18,2);
ALTER TABLE forex_gain_loss ALTER COLUMN original_amount TYPE numeric(18,2) USING original_amount::numeric(18,2);

-- hpp_breakdown
ALTER TABLE hpp_breakdown ALTER COLUMN total_hpp TYPE numeric(18,2) USING total_hpp::numeric(18,2);
...
-- item_transaksi
ALTER TABLE item_transaksi ALTER COLUMN subtotal TYPE numeric(18,2) USING subtotal::numeric(18,2);

-- jurnal_detail
ALTER TABLE jurnal_detail ALTER COLUMN debit TYPE numeric(18,2) USING debit::numeric(18,2);

-- jurnal_entry
ALTER TABLE jurnal_entry ALTER COLUMN total_debit TYPE numeric(18,2) USING total_debit::numeric(18,2);
ALTER TABLE jurnal_entry ALTER COLUMN total_kredit TYPE numeric(18,2) USING total_kredit::numeric(18,2);

-- kartu_stok
ALTER TABLE kartu_stok ALTER COLUMN total_nilai TYPE numeric(18,2) USING total_nilai::numeric(18,2);
...
ALTER TABLE quotes ALTER COLUMN exchange_rate TYPE numeric(18,6) USING exchange_rate::numeric(18,6);
...
ALTER TABLE reconciliation_sessions ALTER COLUMN balance_difference TYPE numeric(18,2) USING balance_difference::numeric(18,2);
ALTER TABLE reconciliation_sessions ALTER COLUMN cleared_balance TYPE numeric(18,2) USING cleared_balance::numeric(18,2);
ALTER TABLE reconciliation_sessions ALTER COLUMN computed_gl_balance TYPE numeric(18,2) USING computed_gl_balance::numeric(18,2);
ALTER TABLE reconciliation_sessions ALTER COLUMN opening_balance TYPE numeric(18,2) USING opening_balance::numeric(18,2);
...
ALTER TABLE reconciliation_sessions ALTER COLUMN statement_closing_balance TYPE numeric(18,2) USING statement_closing_balance::numeric(18,2);
...
ALTER TABLE reconciliation_sessions ALTER COLUMN statement_opening_balance TYPE numeric(18,2) USING statement_opening_balance::numeric(18,2);
...
-- recurring_expenses
ALTER TABLE recurring_expenses ALTER COLUMN amount TYPE numeric(18,2) USING amount::numeric(18,2);
...
ALTER TABLE sales_invoices ALTER COLUMN base_currency_total TYPE numeric(18,2) USING base_currency_total::numeric(18,2);
ALTER TABLE sales_invoices ALTER COLUMN discount_amount TYPE numeric(18,2) USING discount_amount::numeric(18,2);
ALTER TABLE sales_invoices ALTER COLUMN exchange_rate TYPE numeric(18,6) USING exchange_rate::numeric(18,6);
...
ALTER TABLE sales_orders ALTER COLUMN exchange_rate TYPE numeric(18,6) USING exchange_rate::numeric(18,6);
...
-- transaksi_harian
ALTER TABLE transaksi_harian ALTER COLUMN discount_amount TYPE numeric(18,2) USING discount_amount::numeric(18,2);
ALTER TABLE transaksi_harian ALTER COLUMN grand_total TYPE numeric(18,2) USING grand_total::numeric(18,2);
ALTER TABLE transaksi_harian ALTER COLUMN pajak_amount TYPE numeric(18,2) USING pajak_amount::numeric(18,2);
ALTER TABLE transaksi_harian ALTER COLUMN subtotal_after_discount TYPE numeric(18,2) USING subtotal_after_discount::numeric(18,2);
ALTER TABLE transaksi_harian ALTER COLUMN subtotal_before_discount TYPE numeric(18,2) USING subtotal_before_discount::numeric(18,2);
ALTER TABLE transaksi_harian ALTER COLUMN total_nominal TYPE numeric(18,2) USING total_nominal::numeric(18,2);
ALTER TABLE transaksi_harian ALTER COLUMN vat_amount TYPE numeric(18,2) USING vat_amount::numeric(18,2);
...
ALTER TABLE vendor_credits ALTER COLUMN base_currency_total TYPE numeric(18,2) USING base_currency_total::numeric(18,2);
ALTER TABLE vendor_credits ALTER COLUMN discount_amount TYPE numeric(18,2) USING discount_amount::numeric(18,2);
ALTER TABLE vendor_credits ALTER COLUMN exchange_rate TYPE numeric(18,6) USING exchange_rate::numeric(18,6);
...
ALTER TABLE vendor_credits ALTER COLUMN total_cogs TYPE numeric(18,2) USING total_cogs::numeric(18,2);
