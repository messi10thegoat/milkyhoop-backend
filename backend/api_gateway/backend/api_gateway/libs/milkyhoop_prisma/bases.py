...
class BaseRefreshToken(_PrismaModel):
    __prisma_model__: ClassVar[Literal['RefreshToken']] = 'RefreshToken'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.RefreshTokenActions[_PrismaModelT]':
        from .client import get_client

        return actions.RefreshTokenActions[_PrismaModelT](client or get_client(), cls)
...
class BaseTenantRule(_PrismaModel):
    __prisma_model__: ClassVar[Literal['TenantRule']] = 'TenantRule'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.TenantRuleActions[_PrismaModelT]':
        from .client import get_client

        return actions.TenantRuleActions[_PrismaModelT](client or get_client(), cls)
...
class BaseQRLoginToken(_PrismaModel):
    __prisma_model__: ClassVar[Literal['QRLoginToken']] = 'QRLoginToken'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.QRLoginTokenActions[_PrismaModelT]':
        from .client import get_client

        return actions.QRLoginTokenActions[_PrismaModelT](client or get_client(), cls)


class BaseUserDevice(_PrismaModel):
    __prisma_model__: ClassVar[Literal['UserDevice']] = 'UserDevice'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.UserDeviceActions[_PrismaModelT]':
        from .client import get_client

        return actions.UserDeviceActions[_PrismaModelT](client or get_client(), cls)
