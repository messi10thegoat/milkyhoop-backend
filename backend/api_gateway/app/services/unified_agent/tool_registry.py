...
READ_TOOLS: List[Dict[str, Any]] = [
    # ── Master Data Search ──
    {
        ...
        "description": "Cari pelanggan berdasarkan nama, email, atau nomor telepon. Return: id, name, phone, company_name, display_name. GUNAKAN untuk mencari data pelanggan termasuk nomor telepon.",
        "parameters": {
            "type": "object",
            "properties": {
                "q": {
    ...
    {
        "name": "search_vendors",
        "description": "Cari vendor/supplier berdasarkan nama atau kode. Return: id, name, phone, company_name, display_name. GUNAKAN untuk mencari data vendor termasuk nomor telepon.",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Cari rekening bank berdasarkan nama bank atau nomor rekening. Return: id, account_name, bank_name, account_number. Gunakan untuk resolve bank_account_id sebelum update/delete.",
        "input_schema": {
            "type": "object",
            "properties": {
                "query": {
    ...
    },
    {
        ...
        "description": "Ambil daftar invoice/faktur dari satu pelanggan. Gunakan sebelum terima pembayaran — untuk tahu invoice mana yang mau dibayar. Default: hanya outstanding (POSTED/PARTIAL).",
        "input_schema": {
            "type": "object",
            "properties": {
                "customer_id": {
                ...
                "status": {
                    ...
                    "description": "Filter. Default: outstanding (POSTED + PARTIAL)",
                },
            },
    ...
    },
    {
        ...
        "description": "Ambil daftar bill/tagihan dari satu vendor. Gunakan sebelum bayar tagihan — untuk tahu bill mana yang mau dibayar. Default: hanya outstanding (POSTED/PARTIAL).",
        "input_schema": {
            "type": "object",
            "properties": {
                "vendor_id": {
    ...
    {
        "name": "get_invoices",
        "description": "List faktur penjualan. Gunakan search untuk cari berdasarkan nama customer atau nomor faktur. Return: invoice_number, customer_name, total_amount, amount_paid, status. Untuk cari piutang per faktur lebih baik pakai get_ar_aging.",
        "parameters": {
            "type": "object",
            "properties": {
                "search": {
    ...
    {
        "name": "get_bills",
        "description": "List faktur pembelian / tagihan (hutang ke vendor). Bisa filter by status (draft/partial/paid/overdue). Gunakan untuk melihat daftar tagihan, tagihan belum lunas, atau cari tagihan berdasarkan nama vendor / nomor tagihan.",
        "parameters": {
            "type": "object",
            "properties": {
                "status": {
...
ACTION_TOOLS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Use for master data CRUD (bank accounts, vendors) AND bank reconciliation actions "
            "(categorize_statement, confirm_single_match). "
            "Include ALL field values gathered from conversation in the payload object. "
            "The payload MUST contain the relevant fields for the chosen action_key. "
            "For reconciliation actions: copy data from review_next_unmatched into display fields "
            "(statement_description, statement_amount, account_name, etc). "
            "Hidden fields (session_id, statement_line_id) are required but not shown to user."
        ),
        "parameters": {
            "type": "object",
            "properties": {
