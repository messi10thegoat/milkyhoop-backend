...
READ_TOOLS: List[Dict[str, Any]] = [
    ...
    {
        "name": "get_bill_journals",
        "description": "Daftar jurnal akuntansi terkait faktur pembelian.",
        "parameters": {
            "type": "object",
            "properties": {"id": {"type": "string", "description": "UUID faktur"}},
            "required": ["id"],
    ...
    {
        "name": "get_bill_activity",
        "description": "Riwayat aktivitas faktur pembelian (pembayaran, status change, dll).",
        "parameters": {
            "type": "object",
            "properties": {"id": {"type": "string", "description": "UUID faktur"}},
            "required": ["id"],
    ...
    {
        "name": "get_bill_payment_detail",
        "description": "Detail satu pembayaran keluar (bill payment) termasuk alokasi per faktur.",
        "parameters": {
            "type": "object",
            "properties": {"id": {"type": "string", "description": "UUID pembayaran"}},
            "required": ["id"],
        },
    },
    {
        "name": "get_bill_payment_journals",
        "description": "Jurnal akuntansi dari pembayaran keluar (Dr Hutang, Cr Bank).",
        "parameters": {
            "type": "object",
            "properties": {"id": {"type": "string", "description": "UUID pembayaran"}},
            "required": ["id"],
