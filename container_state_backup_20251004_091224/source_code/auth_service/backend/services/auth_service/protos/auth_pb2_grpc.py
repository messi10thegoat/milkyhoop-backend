...
import auth_service_pb2 as auth__pb2
...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserInfo = channel.unary_unary(
                ...
                request_serializer=auth__pb2.UserInfoRequest.SerializeToString,
                response_deserializer=auth__pb2.UserInfoResponse.FromString,
                _registered_method=True)
        self.HealthCheck = channel.unary_unary(
                '/protos.auth.AuthService/HealthCheck',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=auth__pb2.HealthResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserInfo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.UserInfoRequest.FromString,
                    response_serializer=auth__pb2.UserInfoResponse.SerializeToString,
            ),
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    servicer.HealthCheck,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=auth__pb2.HealthResponse.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def GetUserInfo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/protos.auth.AuthService/GetUserInfo',
            auth__pb2.UserInfoRequest.SerializeToString,
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            auth__pb2.HealthResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
